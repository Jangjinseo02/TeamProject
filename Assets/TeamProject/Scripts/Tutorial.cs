    ...
    public void SetTextAndStartRoutine(TutorialType type)
    {
        switch (type)
        {
            case TutorialType.One:
                setText[0] = "혹시 오성전자가 외계인을 납치해서 기술력을 얻고 있다는 농담을 들어본적이 있겠지.";
                setText[1] = "세상을 바꿀 멋진 기술자들을 많이 데려와 주게나. 그게 자네 일이네.";
                setText[2] = "오른쪽에 얼마나 외계인을 납치해야 하는지 적혀 있을 걸세.";
                setText[3] = "할당량을 다 채우면 복귀시켜줄테니 우선 내 말을 따르게.";
            ...
            case TutorialType.Two:
                ...
                setText[1] = "하지만 드릴 뿐만이 아니라, 산소 탱크도 주어졌을 거야.";
                setText[2] = "왼쪽을 한번 보게. 자네의 몸 상태를 눈으로 볼 수 있게 한 것이지.";
                setText[3] = "그 중에서도 파란 것은, 얼마나 더 숨을 쉴 수 있는지 표시한 게이지라네.";
                setText[4] = "마침 저기에 외계인이 보이는구만.";
                setText[5] = "오른쪽으로 이동하여 드릴로 외계인을 기절시키게.";

                StartCoroutine(Diallog(6, true, true));
                break;
            case TutorialType.Three:
                setText[0] = "외계인도 그렇게 기절시키면 될 거야.";
                setText[1] = "이제 아래로 내려가 보게나. 하지만 단단해 보이는 블록은 건들지 말게.";
            ...
            case TutorialType.Four:
                ...
                setText[2] = "하지만 같은 종류의 블록은, 가까이 붙으면 그 블록과 붙는다네.";
                setText[3] = "그리고, 붙은 블록들이 4개 이상이 된다면 사라져 버릴걸세.";
            ...
            case TutorialType.Five:
                ...
                setText[2] = "이건 자네의 몸이 얼마나 더 버틸 수 있을지 나타낸 것이네.";
                setText[3] = "이 두 게이지 중 하나가 다한다면 다시 복귀해야 할 거야.";
                setText[4] = "이제 아래 블록을 부수면 된다네.";
                setText[5] = "만약 외계인 할당량을 다 채웠다면, 복귀할 수 있지.";
                setText[6] = "지금 할당량을 다 채웠으니, 아래 블록을 부수어 복귀하게.";
